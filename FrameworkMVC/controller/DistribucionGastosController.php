			...
			if (!empty($resultPer))
			{
				if (isset ($_GET["id_distribucion_gastos"])   )
				{
					...
					if (!empty($resultPer))
					{
						...
						$columnas = " id_distribucion_gastos, nombre_distribucion_gastos";
						$tablas   = "distribucion_gastos";
						$where    = "id_distribucion_gastos= '$_id_distribucion_gastos' "; 
						$id       = "nombre_distribucion_gastos";
							
						$resultEdit = $distribucion_gastos ->getCondiciones($columnas ,$tablas ,$where, $id);

						$traza=new TrazasModel();
						$_nombre_controlador = "Distribucion Gastos";
						$_accion_trazas  = "Editar";
						$_parametros_trazas = $_id_distribucion_gastos;
