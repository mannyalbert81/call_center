...
class DocumentosTipoDocumentosController extends ControladorBase{
	...
	public function devuelveTipoDocumentos()
	{
		$result = array();
	
			$tipo_documentos=new TipoDocumentosModel();
	
			$columnas = "tipo_documentos.id_tipo_documentos, tipo_documentos.nombre_tipo_documentos  ";
			$tablas   = "public.documentos_legal,public.tipo_documentos";
			$where    = "tipo_documentos.id_tipo_documentos = documentos_legal.id_tipo_documentos ";
			$id       = "tipo_documentos.nombre_tipo_documentos";
			
			
			$result = $tipo_documentos->getCondiciones($columnas ,$tablas ,$where, $id);
