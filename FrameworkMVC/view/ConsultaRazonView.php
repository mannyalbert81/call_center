...
<html lang="es">
      ...
      <head>
        ...
        <meta charset="utf-8"/>
        <title>Consulta Razon - coactiva 2016</title>
		...
		$("#id_ciudad").change(function(){
           ...
           $ddl_secretario.empty();
            ...
            if(ddl_ciudad != 0)
            {
         	   ...
         	   $.post("<?php echo $helper->url("ConsultaRazon","Secrtetarios"); ?>", datos, function(resultSecretario) {
  ...
  <div class="row" style="background-color: #ffffff;">
      ...
      <form action="<?php echo $helper->url("ConsultaRazon","consulta_razon"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12">
         
         <!-- comienxza busqueda  -->
         <div class="col-lg-12" style="margin-top: 10px">
         
       	 <h4 style="color:#ec971f;">Consulta Razon</h4>
		 ...
		 <section class="" style="height:300px;overflow-y:scroll;">
               ...
               <?php if (!empty($resultCita)) {?>
		    	...
		    	<?php } }elseif (!empty($resultProv)) {?>
		    		...
		    		foreach($resultProv as $res) {   ?>
		               ...
		               <td style="color:#000000;font-size:80%;">
		               <a href="<?php echo $helper->url("ConsultaRazon","abrirPdf_providencias"); ?>&id=<?php echo $res->id_documentos; ?>" onclick="window.open(this.href, this.target, ' width=1000, height=800, menubar=no');return false" class="btn btn-success" onClick="Ok()" style="font-size:65%;">-- VER --</a>
		               </td> 
		    		</tr>
	         ...
	         <tr >
		    	...
		    	<?php  foreach($resultOfi as $res) {   ?>
		               ...
		               <td style="color:#000000;font-size:80%;">
		               <a href="<?php echo $helper->url("ConsultaRazon","abrirPdf_oficios"); ?>&id=<?php echo $res->id_oficios; ?>" onclick="window.open(this.href, this.target, ' width=1000, height=800, menubar=no');return false" class="btn btn-success" onClick="Ok()" style="font-size:65%;">-- VER --</a>
		               </td> 
		    		</tr>
	         ...
	         <tr >
	    		...
	    		<th></th>
		    		...
		    		<?php foreach($resultAvoCono as $res) {   ?>
		               ...
		               <td style="color:#000000;font-size:80%;">
		               <a href="<?php echo $helper->url("ConsultaRazon","abrirPdf_avoco_conocimiento"); ?>&id=<?php echo $res->id_avoco_conocimiento; ?>" onclick="window.open(this.href, this.target, ' width=1000, height=800, menubar=no');return false" class="btn btn-success" onClick="Ok()" style="font-size:65%;">-- VER --</a>
		               </td> 
		    		</tr>
	         ...
	         <tr >
	    		...
	    		<th></th>
		      		...
		      		<tr>
		               ...
		               <td style="color:#000000;font-size:80%;">
		               <a href="<?php echo $helper->url("ConsultaRazon","abrirPdf_auto_pago"); ?>&id=<?php echo $res->id_auto_pagos; ?>" onclick="window.open(this.href, this.target, ' width=1000, height=800, menubar=no');return false" class="btn btn-success" onClick="Ok()" style="font-size:65%;">-- VER --</a>
		               </td> 
		    		</tr>
