	        		...
	        		<tr>
		    	      ...
		    	      <td> <?php echo $res->cierre_ventas_soat ?>     </td>
		    	       <td> <?php echo $res->creado; ?>     </td>
			             ...
			             <td>
			           		<div class="right">
			                    <a href="<?php echo $helper->url("DocumentosCartonDocumentos","index"); ?>&id_documentos_legal=<?php echo $res->id_documentos_legal; ?>" class="btn btn-info" target="blank">Editar</a>
