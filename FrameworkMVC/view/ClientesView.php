...
<html lang="es">
      ...
      <head>
        ...
        <meta charset="utf-8"/>
        <title>Clientes - CallCenter 2016</title>
		...
		$(document).ready(function(){
		    ...
		    $("#Guardar").click(function() 
			{
		    	...
		    	if (telefono_clientes == "")
		    	{
		    		...
		    		$("#mensaje_telefono_clientes").text("Introduzca un Tel茅fono");
		    	...
		    	if (direccion_clientes == "")
		    	{
		    		...
		    		$("#mensaje_direccion_clientes").text("Introduzca una Direcci贸n");
  ...
  <div></div>
      ...
      <form action="<?php echo $helper->url("Clientes","InsertaClientes"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-6">
         ...
         <div class="row">
		    ...
		    <div class="col-xs-6 col-md-6">
			  	<p  class="formulario-subtitulo" >Numero de Identificaci贸n</p>
		    ...
		    <div class="col-xs-6 col-md-6">
			  ...
			  <div class="col-xs-6 col-md-6">
			  	<p  class="formulario-subtitulo" >Tel茅fono</p>
		    ...
		    <div class="col-xs-6 col-md-6">
			  ...
			  <div class="col-xs-6 col-md-6">
			  	<p  class="formulario-subtitulo" >Direcci贸n</p>
		    ...
		    <div class="col-xs-6 col-md-6" style="margin-top:10px">
			  	<p  class="formulario-subtitulo" >Numero de Identificaci髇 Garante</p>
       ...
       <section class="col-lg-12  usuario" style="height:400px;overflow-y:scroll;">
        <table class="table table-hover ">
	         <tr >
	    		...
	    		<th style="color:#456789;font-size:80%;">Identifiaci贸n</th>
	    		<th style="color:#456789;font-size:80%;">Nombres Cliente </th>
	    		<th style="color:#456789;font-size:80%;">Tel茅fono</th>
	    		<th style="color:#456789;font-size:80%;">Celular</th>
	    		<th style="color:#456789;font-size:80%;">Direcci贸n</th>
