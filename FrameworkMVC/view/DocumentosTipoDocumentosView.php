...
<?php require_once 'config/global.php';?> 
		...
		$(document).ready(function(){
               ...
               $tipo_documentos.append("<option value= " +"0" +" > --TODOS--</option>");
            	   ...
            	   $.post("<?php echo $helper->url("TiposDocumentos","devuelveTiposDocumentos"); ?>", datos, function(result) {

            		 		$.each(result, function(index, value) {
               		 	    $tipo_documentos.append("<option value= " +value.id_tipo_documentos +" >" + value.tipo_documentos  + "</option>");	
                       		 });
            	...
            	<td>
				 ...
				 <input type="date" name="fecha_documento_desde" id="fecha_documento_desde"  class="form-control"  value="<?php echo  date('d/m/Y', strtotime($resEdit->fecha_documentos_legal));  ?>"     /> 	
				  ...
				  <?php } ?>
		   		...
		   		<td>
		   		  <?php if ($resultEdit !="" ) { foreach($resultEdit as $resEdit) {?>
						...
						<input type="date" name="fecha_poliza_desde" id="fecha_poliza_desde"  class="form-control"   value="<?php echo  date('d/m/Y', strtotime($resEdit->fecha_desde_documentos_legal));  ?>"     /> 	
						    
				  <?php } } else {?>
				   	<?php if ($sel_fecha_poliza_desde == "" ) { ?>	
				   		<input type="date" name="fecha_poliza_desde"  id="fecha_poliza_desde"  class="form-control"  />
					 <?php } else {?>	
					 	<input type="date" value="<?php echo $sel_fecha_poliza_desde ?>"  name="fecha_poliza_desde" id="fecha_poliza_desde"   class="form-control"   />
					 <?php }?>        
				  ...
				  <?php } ?>
		   		...
		   		<td>
		   		  <?php if ($resultEdit !="" ) { foreach($resultEdit as $resEdit) {?>
						...
						<input type="date" name="fecha_poliza_hasta" id="fecha_poliza_hasta"  class="form-control"   value="<?php echo date('d/m/Y', strtotime($resEdit->fecha_hasta_documentos_legal));  ?>"     /> 	
				  ...
				  <?php } } else {?>
					 	...
					 	<?php } else {?>	
					 		<input type="date" value="<?php echo $sel_fecha_poliza_hasta ?>"  name="fecha_poliza_hasta" id="fecha_poliza_hasta"   class="form-control"   />
					 	<?php }?>        
