	         ...
	         <tr >
	            ...
	            <?php if (!empty($resultSet)) {  foreach($resultSet as $res) {?>
	        		<tr>
		               ...
		               <div class="right">
			                	<a href="/FrameworkMVC/view/ireports/ContRazonReport.php?id_usuarios=<?php echo $res->id_usuarios; ?>"onclick="window.open(this.href, this.target, ' width=1000, height=800, menubar=no');return false"; class="btn btn-success" style="font-size:65%;">Asentar Razon</a>
			                 </div>
