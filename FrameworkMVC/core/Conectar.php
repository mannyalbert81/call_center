...
class Conectar{
    ...
    public function conexion(){
        ...
        if($this->driver=="pgsql" || $this->driver==null){
        	...
        	$con = pg_connect("host=181.198.188.2 port=5432 dbname=ad_copseguros user=postgres password=.Romina.2012 ");
        	if(!$con){
    ...
    public function startFluent(){
        ...
        if($this->driver=="pgsql" || $this->driver==null){
        	...
        	try
        	{
        		$pdo = new PDO('pgsql:host=181.198.188.2;port=5432;dbname=ad_copseguros', 'postgres', '.Romina.2012' );
